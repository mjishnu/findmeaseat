...
const LIGHT_STYLES: Record<AvailabilityStatus, string> = {
  ...
  [AvailabilityStatus.RAC]: 'border-signal-amber/60 bg-signal-amber/20 text-signal-amber-deep',
...
const DARK_STYLES: Record<AvailabilityStatus, string> = {
  ...
  [AvailabilityStatus.RAC]: 'border-signal-amber/50 bg-signal-amber/25 text-signal-amber-bright',
